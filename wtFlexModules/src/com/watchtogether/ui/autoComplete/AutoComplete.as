package com.watchtogether.ui.autoComplete{
	...
	[Event (name="select", type="com.watchtogether.ui.autoComplete.CustomEvent")]
	
	[Event (name="textChanged", type="com.watchtogether.ui.autoComplete.CustomEvent")]
	...
	public class AutoComplete extends SkinnableComponent
	{
		...
		public function AutoComplete()
		{
			...
			_collection.addEventListener(CollectionEvent.COLLECTION_CHANGE, collectionChange)
		...
		public function set dataProvider(value:Object):void
		{
			...
			if (list) list.dataProvider = _collection;
			
			filterData();
		}
		
		public function get dataProvider():Object { return _collection; }
		...
		private function onChange(event:TextOperationEvent):void
		{
			...
			var e:CustomEvent = new CustomEvent("textChanged", _text);
			dispatchEvent(e);
		}
		...
		public function filterData():void
		{
			...
			if ((text=="" || _collection.length==0) && !forceOpen ){
				...
				list.height = Math.min(maxRows, _collection.length) * 22 + 2 ;
				list.validateNow()
		...
		public function acceptCompletion() : void
		{
			if (list.selectedIndex >= 0)
			{
				...
				_selectedItem = _collection.getItemAt(_selectedIndex)
