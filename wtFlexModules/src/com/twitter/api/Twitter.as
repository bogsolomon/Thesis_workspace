...
package com.twitter.api {
        ...
        public class Twitter extends EventDispatcher
        {
                ...
                private static const LOAD_FRIENDS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/friends/$userId.xml";
                private static const LOAD_FRIENDS_TIMELINE_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/friends_timeline/$userId.xml";
				private static const LOAD_RE_TWEET_BY_ME_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/retweeted_by_me.xml";
                private static const PUBLIC_TIMELINE_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/public_timeline.xml"
                private static const HOME_TIMELINE_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/home_timeline.xml"
                private static const LOAD_USER_TIMELINE_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/user_timeline/$userId.xml&" +
                        "count=$count&page=$page"
                private static const FOLLOW_USER_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/friendships/create/$userId.xml";
                private static const SET_STATUS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/update.xml";
                private static const RE_TWEET_URL:String =
						DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/retweet/$msgId.xml";
                        //"http://api.twitter.com/1/statuses/retweet/$msgId.xml";
                private static const SHOW_STATUS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/show/$id.xml";
                private static const REPLIES_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/replies.xml";
                private static const DESTROY_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/destroy/$id.xml";
                private static const FOLLOWERS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/followers.xml";
                private static const FEATURED_USERS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/statuses/featured.xml";
                ...
                private static const SEND_DIRECT_MSG_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/direct_messages/new.xml";
                private static const SEARCH_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://search.twitter.com/search.atom&";
                private static const VERIFY_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/account/verify_credentials.xml";
                private static const UPDATE_LOCATON_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/account/update_location";
                private static const RATE_LIMIT_STATUS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/account/rate_limit_status.xml";
                private static const END_SESSION_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/account/end_session.xml";
                private static const GET_SENT_DIRECT_MESSAGE_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/direct_messages/sent.xml";
                private static const SHOW_INFO_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/users/show/${id}.xml";
                private static const FRIENDS_IDS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/friends/ids/${id}.xml";
                private static const FOLLOWERS_IDS_URL:String =
                        DeploymentConstants.PROXY_HTTP+"http://twitter.com/followers/ids/${id}.xml";
                 ...
                 */
                 public function setAuthenticationCredentials(username:String, password:String):void
                 {
                        if (username != null && password != null){
                                ...
                                encodedCredentials = Base64.encode(creds);
                                authorizationHeader =
                ...
                */
                public function loadHomeTimeline(count:Number):void
                {
                        var homeTimelineLoader:URLLoader = this.getLoader(HOME_TIMELINE);
						var homeCount:String = "count="+count;
                        homeTimelineLoader.load(twitterRequest(HOME_TIMELINE_URL+"&"+homeCount));
                }
                /**
                ...
                */
                 ...
                 */
                public function loadReplies(count:Number):void
                {
                        var repliesLoader:URLLoader = this.getLoader(REPLIES);
						var replyCount:String = "count="+count;
                        repliesLoader.load(twitterRequest(REPLIES_URL+"&"+replyCount));
                }
            ...
            for each (var tempXML:XML in xml.children()) {
                ...
                private function twitterRequest (url : String):URLRequest
                {
                        ...
                        */
                        var r:URLRequest = new URLRequest (url+"&Authorization="+encodedCredentials);
                        if (this.authorizationHeader){
                                r.requestHeaders = [this.authorizationHeader];  
                        }
                        return r;
