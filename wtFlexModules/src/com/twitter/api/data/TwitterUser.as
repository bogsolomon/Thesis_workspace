package com.twitter.api.data{
	import com.watchtogether.code.iface.media.AbstractSearchResult;
        ...
        /**
                ...
                */
        public class TwitterUser extends AbstractSearchResult{
                /**
                ...
                */
				...
				public var isInUserViewMode:Boolean = false;
...
//              public function get url():String { return URL; }
				...
				// For Search Results Renderer
				override public function get thumbnailUrl():String{return profileImageUrl;}
				
				override public function get title():String{
					var out:String;
					if(screenName != null) out = screenName;
					else out = name;
					return out;
				}
				
				override public function get subtitle():String
				{
					var output:String = "";
					if(isInUserViewMode)
					{
					...
					output += status.text+" ("+status.createdAt.toLocaleDateString()+ ")";
					return output;
				}
        }
}
